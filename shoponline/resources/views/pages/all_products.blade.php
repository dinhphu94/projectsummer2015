@extends('app')
@section('title')GFashion | Products @endsection

@section('styles')
<link rel="stylesheet" href="{{Asset('shop/css/jquery.nouislider.css')}}">
<link rel="stylesheet" href="{{Asset('shop/css/isotope.css')}}">
<link rel="stylesheet" href="{{Asset('shop/css/innerpage.css')}}">
@endsection

@push('bodyclass')<body class="products-view">@endpush
			...
			<div class="container">
				<div class="relative">
					<ul class="bc push-up unstyled clearfix">
						...
						<li class="{{URL::to('products')}}">Products</li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="m-t-b clearfix">
						...
						<aside class="col-xs-12 col-sm-4 col-md-3">
							<section class="sidebar push-up">
										...
										<ul class="product-medialist li-m-t unstyled clearfix">
											<li>
												<div class="item clearfix">
													<a href="{{Asset('shop/images/women/basic/688086-0286_1.jpg')}}" data-toggle="lightbox" class="entry-thumbnail">
														<img src="{{Asset('shop/images/women/basic/688086-0286_1_t.jpg')}}" alt="Inceptos orci hac libero" />
													</a>
											...
											<li>
												<div class="item clearfix">
													<a href="{{Asset('shop/images/women/basic/589550-0014_1.jpg')}}" data-toggle="lightbox" class="entry-thumbnail">
														<img src="{{Asset('shop/images/women/basic/589550-0014_1_t.jpg')}}" alt="Inceptos orci hac libero" />
													</a>
													<h5 class="entry-title"><a href="product.html">Inceptos orci hac libero</a></h5>
								...
								<!-- PROMO -->
								<div class="promo inverse-background" style="background: url('{{Asset('shop/images/demo/Barn-Dress-Girl_t.jpg')}}') no-repeat; background-size: auto 100%;">
								...
								<div class="products-layout grid m-t-b add-cart" data-product=".product" data-thumbnail=".entry-media .thumb" data-title=".entry-title > a" data-url=".entry-title > a" data-price=".entry-price > .price">
									...
									<div class="product" data-product-id="1" data-category="women|women-jeans|women-skirt" data-brand="brand1" data-price="250" data-colors="red|blue|black|white" data-size="S|M|L">
										<div class="entry-media">
											<img data-src="{{Asset('shop/images/women/skirt/430041-0014_1_t.jpg')}}" alt="" class="lazyLoad thumb" />
											<div class="hover">
												...
												<ul class="icons unstyled">
													...
													<li>
														<a href="{{Asset('shop/images/women/skirt/430041-0014_1.jpg')}}" class="circle" data-toggle="lightbox"><i class="iconfont-search"></i></a>
													</li>
													<li>
									...
									<div class="product" data-product-id="2" data-category="women|women-accessories|women-basics|women-legging|new" data-brand="brand2" data-price="450" data-colors="red|green|black|white|silver" data-size="XS|S|M">
										<div class="entry-media">
											<img data-src="{{Asset('shop/images/women/accessories/582120-0029_1_t.jpg')}}" alt="" class="lazyLoad thumb" />
											<div class="hover">
												<a href="product.html" class="entry-url"></a>
												<ul class="icons unstyled">
													<li>
														<a href="{{Asset('shop/images/women/accessories/582120-0029_1.jpg')}}" class="circle" data-toggle="lightbox"><i class="iconfont-search"></i></a>
													</li>
													<li>
														<a href="#" class="circle add-to-cart"><i class="iconfont-shopping-cart"></i></a>
													</li>
									...
									<div class="product" data-product-id="3" data-category="men|men-jacket|men-accessories|men-jumper|new" data-brand="brand2" data-price="450" data-colors="purple|brown|black|white|patternie" data-size="S|M|L|XL">
										<div class="entry-media">
											<img data-src="{{Asset('shop/images/men/accessories/255615-0014_1_t.jpg')}}" alt="" class="lazyLoad thumb" />
											<div class="hover">
												<a href="product.html" class="entry-url"></a>
												<ul class="icons unstyled">
													<li>
													...
													<li>
														<a href="{{Asset('shop/images/men/accessories/255615-0014_1.jpg')}}" class="circle" data-toggle="lightbox"><i class="iconfont-search"></i></a>
													</li>
													<li>
														<a href="#" class="circle add-to-cart"><i class="iconfont-shopping-cart"></i></a>
													</li>
									...
									<div class="product" data-product-id="4" data-category="men|men-jacket|men-accessories|men-jeans|men-jumper" data-brand="brand3" data-price="350" data-colors="purple|brown|black|white|red" data-size="S|M|L|XL|XXL">
										<div class="entry-media">
											<img data-src="{{Asset('shop/images/men/blazer/677326-0014_1_t.jpg')}}" alt="" class="lazyLoad thumb" />
											<div class="hover">
												<a href="product.html" class="entry-url"></a>
												<ul class="icons unstyled">
													<li>
														<a href="{{Asset('shop/images/men/blazer/677326-0014_1.jpg')}}" class="circle" data-toggle="lightbox"><i class="iconfont-search"></i></a>
													</li>
													<li>
														<a href="#" class="circle add-to-cart"><i class="iconfont-shopping-cart"></i></a>
													</li>
									...
									<div class="product" data-product-id="5" data-category="men|men-shoe|men-accessories|men-jean|new" data-brand="brand4" data-price="250" data-colors="brown|silver|black|green|red" data-size="L|XL|XXL">
										<div class="entry-media">
											<img data-src="{{Asset('shop/images/men/shoes/000312-2259_1_t.jpg')}}" alt="" class="lazyLoad thumb" />
											<div class="hover">
												<a href="product.html" class="entry-url"></a>
												<ul class="icons unstyled">
													<li>
													...
													<li>
														<a href="{{Asset('shop/images/men/shoes/000312-2259_1.jpg')}}" class="circle" data-toggle="lightbox"><i class="iconfont-search"></i></a>
													</li>
													<li>
														<a href="#" class="circle add-to-cart"><i class="iconfont-shopping-cart"></i></a>
													</li>
									...
									<div class="product" data-product-id="6" data-category="women|women-legging|women-dresses|women-jeans|women-skirt" data-brand="brand5" data-price="350" data-colors="white|silver|green|red|blue" data-size="XS|S">
										<div class="entry-media">
											<img data-src="{{Asset('shop/images/women/jeans/220008-0054_1_t.jpg')}}" alt="" class="lazyLoad thumb" />
											<div class="hover">
												<a href="product.html" class="entry-url"></a>
												<ul class="icons unstyled">
													<li>
														<a href="{{Asset('shop/images/women/jeans/220008-0054_1.jpg')}}" class="circle" data-toggle="lightbox"><i class="iconfont-search"></i></a>
													</li>
													<li>
														<a href="#" class="circle add-to-cart"><i class="iconfont-shopping-cart"></i></a>
													</li>
									...
									<div class="product" data-product-id="7" data-category="women|women-swimwear|best|new" data-brand="brand5" data-price="150" data-colors="white|black|patternie" data-size="XS|S">
										<div class="entry-media">
											<img data-src="{{Asset('shop/images/women/swimwear/116796-0001_1_t.jpg')}}" alt="" class="lazyLoad thumb" />
											<div class="hover">
												<a href="product.html" class="entry-url"></a>
												<ul class="icons unstyled">
													<li>
													...
													<li>
														<a href="{{Asset('shop/images/women/swimwear/116796-0001_1.jpg')}}" class="circle" data-toggle="lightbox"><i class="iconfont-search"></i></a>
													</li>
													<li>
														<a href="#" class="circle add-to-cart"><i class="iconfont-shopping-cart"></i></a>
													</li>
									...
									<div class="product" data-product-id="8" data-category="women|women-dresses|best" data-brand="brand4" data-price="350" data-colors="white|black" data-size="XS|S|L">
										<div class="entry-media">
											<img data-src="{{Asset('shop/images/women/dress/278638-0083_1_t.jpg')}}" alt="" class="lazyLoad thumb" />
											<div class="hover">
												<a href="product.html" class="entry-url"></a>
												<ul class="icons unstyled">
													<li>
									...
									<div class="product" data-product-id="9" data-category="men|men-accessories|men-jean|best|new" data-brand="brand5" data-price="850" data-colors="white|black" data-size="L|XL|XXL">
										<div class="entry-media">
											<img data-src="{{Asset('shop/images/men/accessories/000095-0014_2_t.jpg')}}" alt="" class="lazyLoad thumb" />
											<div class="hover">
												<a href="product.html" class="entry-url"></a>
												<ul class="icons unstyled">
													<li>
									...
									<div class="product" data-product-id="10" data-category="women|women-basics|new" data-brand="brand1" data-price="550" data-colors="white|black|patternie" data-size="XS|S">
										<div class="entry-media">
											<img data-src="{{Asset('shop/images/women/basic/848051-0014_1_t.jpg')}}" alt="" class="lazyLoad thumb" />
											<div class="hover">
												<a href="product.html" class="entry-url"></a>
												<ul class="icons unstyled">
													<li>
									...
									<div class="product" data-product-id="11" data-category="women|women-basics|makeup" data-brand="brand3" data-price="700" data-colors="white|black|red|green|brown" data-size="XS|S">
										<div class="entry-media">
											<img data-src="{{Asset('shop/images/women/basic/848099-0067_1_t.jpg')}}" alt="" class="lazyLoad thumb" />
											<div class="hover">
												<a href="product.html" class="entry-url"></a>
												<ul class="icons unstyled">
													<li>
...
<!-- Particular Page Javascripts -->
	<script src="{{Asset('shop/js/jquery.nouislider.js')}}"></script>
