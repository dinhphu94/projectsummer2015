              ...
              <section class="widget widget-ads">
                <div class="widget-content">
                  <div class="center-xs">
                    <div class="ads">
                      <a href="#">
                        <img src="{{Asset('shop/images/demo/images-footer.jpg')}}" alt="" />
                      </a>
          ...
          <div class="col-xs-12 col-sm-6 center-xs">
            <div class="pull-right">
              <div class="vmid">
                ...
                <a href="#"><img src="{{Asset('shop/img/visacard.png')}}" alt="" width="40" /></a>
                <a href="#"><img src="{{Asset('shop/img/mastercard.png')}}" alt="" width="40" /></a>
                <a href="#"><img src="{{Asset('shop/img/paypal.png')}}" alt="" width="40" /></a>
              </div>
            </div>
          </div>
        </div>
