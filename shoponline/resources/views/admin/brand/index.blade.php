...
@section('title')Admin | Size @endsection
...
<div class="main">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-btc"></i>{{ trans('admin/brand.brand') }}</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.html">{{ trans('admin/modal.home') }}</a></li>
                        <li><i class="fa fa-btc"></i>{{ trans('admin/brand.brand') }}</li>                           
                    </ol>
                </div>
            </div>
         <div class="page-header">   
        <h3>
            {{ trans('admin/brand.brand') }}
            ...
            <div class="row">
                ...
                <table class="table table-striped table cell-border" id="table" style="text-align:center;">
                    <thead>
                        <tr>
                            <th style="text-align:center;">{{ trans('admin/brand.brand_name') }}</th>
