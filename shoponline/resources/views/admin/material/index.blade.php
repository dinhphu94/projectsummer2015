...
@section('title')Admin | Material @endsection
...
<div class="main">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-cogs"></i>{{ trans('admin/material.material') }}</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.html">{{ trans('admin/modal.home') }}</a></li>
                        <li><i class="fa fa-cogs"></i>{{ trans('admin/material.material') }}</li>                           
                    </ol>
                </div>
            </div>
        ...
        <h3>
            ...
            <div class="row">
                ...
                <table class="table table-striped table cell-border" id="table" style="text-align:center;">
                    <thead>
                        <tr>
                            <th style="text-align:center;">{{ trans('admin/material.material_name') }}</th>
...
<script type="text/javascript">
        ...
        $(document).ready(function () {
            oTable = $('#table').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "{{ URL::to('admin/material/data') }}",
