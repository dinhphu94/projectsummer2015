...
@section('title')Admin | Madein @endsection
...
<div class="main">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-tag"></i>{{ trans('admin/madein.madein') }}</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.html">{{ trans('admin/modal.home') }}</a></li>
                        <li><i class="fa fa-tag"></i>{{ trans('admin/madein.madein') }}</li>                           
                    </ol>
                </div>
            </div>
         <div class="page-header">   
        <h3>
            {{ trans('admin/madein.madein') }}
            <div class="pull-right">
                <div class="pull-right">
                    <a href="{{{ URL::to('admin/madein/create') }}}"
            ...
            <div class="row">
                ...
                <table class="table table-striped table cell-border" id="table" style="text-align:center;">
                    <thead>
                        <tr>
                            <th style="text-align:center;">{{ trans('admin/madein.madein_name') }}</th>
